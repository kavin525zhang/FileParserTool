...
if __name__ == "__main__":
    parser = PDFParser(file_name="resnet.pdf", file_type="pdf")
    with open("/home/transwarp/Documents/transwarp/RAG优化/春季守护行动方案.pdf", "rb") as f:
        doc = parser.parse_into_text(f.read())
